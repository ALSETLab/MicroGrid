...
equation
  ...
  connect(control2Real1.OutputReal, Kiq_q.u) annotation(Line(visible = true, origin = {-20.5, -30.522}, points = {{-19.5, 5.522}, {5.5, 5.522}, {5.5, -5.522}, {8.5, -5.522}}, color = {1, 37, 163}));
  ...
  connect(SumDAxis.u2, Kid_d.y) annotation(Line(visible = true, origin = {42, 30.568}, points = {{35, -5.567}, {-2, -5.567}, {-2, 5.567}, {-31, 5.567}}, color = {1, 37, 163}));
  ...
  connect(Kv_q.y, SumQAxis.u1) annotation(Line(visible = true, origin = {52, 25.433}, points = {{-41, 38.432}, {8, 38.432}, {8, -38.432}, {25, -38.432}}, color = {1, 37, 163}));
  connect(Kid_q.y, SumQAxis.u2) annotation(Line(visible = true, origin = {37, -5.291}, points = {{-26, 19.708}, {-7, 19.708}, {-7, -19.708}, {40, -19.708}}, color = {1, 37, 163}));
  connect(Kiq_q.y, SumQAxis.u3) annotation(Line(visible = true, origin = {59, -36.521}, points = {{-48, 0.478}, {15, 0.478}, {15, -0.478}, {18, -0.478}}, color = {1, 37, 163}));
  connect(feedback1.y, IntD_vdc.u) annotation(Line(visible = true, origin = {66.75, 103.62}, points = {{-87.75, 3.62}, {28.25, 3.62}, {28.25, -3.62}, {31.25, -3.62}}, color = {1, 37, 163}));
  connect(IntQ_vdc.u, feedback1.y) annotation(Line(visible = true, origin = {59.25, 88.62}, points = {{38.75, -18.62}, {20.75, -18.62}, {20.75, 18.62}, {-80.25, 18.62}}, color = {1, 37, 163}));
  ...
  connect(md.y, add2.u1) annotation(Line(visible = true, origin = {267, 57.828}, points = {{-16, 13.828}, {3, 13.828}, {3, -13.828}, {10, -13.828}}, color = {1, 37, 163}));
  connect(mq.y, add1.u2) annotation(Line(visible = true, origin = {266.357, -55.62}, points = {{-17.93, -11.62}, {3.643, -11.62}, {3.643, 11.62}, {10.643, 11.62}}, color = {1, 37, 163}));
  ...
  connect(real2Control1.OutputSignal, dq2abc1.v_d) annotation(Line(visible = true, origin = {360.092, 21.374}, points = {{-10.842, 13.776}, {-0.092, 13.776}, {-0.092, -13.776}, {11.027, -13.776}}, color = {0, 128, 0}));
  connect(real2Control2.OutputSignal, dq2abc1.v_q) annotation(Line(visible = true, origin = {360.151, -21.425}, points = {{-10.901, -13.425}, {-0.151, -13.425}, {-0.151, 13.425}, {11.204, 13.425}}, color = {0, 128, 0}));
  connect(Delta, dq2abc1.Delta) annotation(Line(visible = true, origin = {153.035, -80.025}, points = {{-247.862, 4.852}, {-113.035, 4.852}, {-113.035, -35.38}, {236.965, -35.38}, {236.965, 61.056}}, color = {0, 128, 0}));
