...
model DSOGI_PLL
  ...
  SOGI sogi_2(FilterGain = sogiGain, FrequencyHz = SysFreq) annotation(Placement(visible = true, transformation(origin = {0, -46.107}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  SOGI sogi_1(FilterGain = sogiGain, FrequencyHz = SysFreq) annotation(Placement(visible = true, transformation(origin = {0, 50}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
equation
  ...
  connect(vC, ClarkeTransform.v_C) annotation(Line(visible = true, origin = {-90.149, -29.047}, points = {{-4.851, -35.953}, {-4.851, 17.976}, {9.702, 17.976}}, color = {255, 0, 0}));
  connect(ClarkeTransform.v_alfa, control2Real1.InputSignal) annotation(Line(visible = true, origin = {-46.56, 5.368}, points = {{-4.499, 0.01}, {0.866, 0.01}, {0.866, -0.01}, {2.766, -0.01}}, color = {0, 128, 0}));
  connect(ClarkeTransform.v_beta, control2Real2.InputSignal) annotation(Line(visible = true, origin = {-46.541, -5.438}, points = {{-4.443, 0.183}, {0.848, 0.183}, {0.848, -0.183}, {2.748, -0.183}}, color = {0, 128, 0}));
  connect(control2Real1.OutputReal, gain1.u) annotation(Line(visible = true, origin = {-21.564, 7.737}, points = {{-3.129, -2.279}, {1.564, -2.279}, {1.564, 4.558}}, color = {1, 37, 163}));
  ...
  connect(sogi_1.v_in, gain1.y) annotation(Line(visible = true, origin = {-16.552, 44.961}, points = {{6.896, 4.833}, {-3.448, 4.833}, {-3.448, -9.665}}, color = {1, 37, 163}));
  connect(sogi_2.v_in, gain2.y) annotation(Line(visible = true, origin = {-16.552, -42.549}, points = {{6.896, -3.765}, {-3.448, -3.765}, {-3.448, 7.529}}, color = {1, 37, 163}));
  ...
  connect(sogi_2.v, add2.u2) annotation(Line(visible = true, origin = {22, -33.553}, points = {{-12, -7.553}, {-2, -7.553}, {-2, 7.553}, {16, 7.553}}, color = {1, 37, 163}));
  ...
  connect(real2Control2.OutputSignal, park1.v_alfa) annotation(Line(visible = true, origin = {90.825, 13.381}, points = {{-5.493, 6.719}, {-0.825, 6.719}, {-0.825, -6.719}, {7.144, -6.719}}, color = {0, 128, 0}));
  connect(park1.v_beta, real2Control1.OutputSignal) annotation(Line(visible = true, origin = {90.901, -13.497}, points = {{7.003, 6.403}, {-0.901, 6.403}, {-0.901, -6.403}, {-5.201, -6.403}}, color = {0, 128, 0}));
  ...
  connect(park1.v_q, control2Real4.InputSignal) annotation(Line(visible = true, origin = {133.644, -20.414}, points = {{-5.059, 13.752}, {1.11, 13.752}, {1.11, -9.686}, {5.323, -9.686}}, color = {0, 128, 0}));
  connect(add3.y, integrator1.u) annotation(Line(visible = true, origin = {219.5, -35.859}, points = {{-3.5, 0}, {3.5, 0}}, color = {1, 37, 163}));
  connect(PI.y, add3.u1) annotation(Line(visible = true, origin = {189.691, -29.929}, points = {{-3.928, -0.071}, {0.309, -0.071}, {0.309, 0.071}, {3.309, 0.071}}, color = {1, 37, 163}));
