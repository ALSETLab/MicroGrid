...
model TriangPWM_1Ph
  ...
  Modelica.Blocks.Interfaces.BooleanOutput fire_compl "Firing PWM signal" annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 90, origin = {60, 110}), visible = true, iconTransformation(origin = {68, 102}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
equation
