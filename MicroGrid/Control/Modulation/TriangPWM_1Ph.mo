...
model TriangPWM_1Ph
  ...
  Modelica.Blocks.Nonlinear.Limiter limiter(uMax = 1, uMin = -1) annotation(Placement(transformation(extent = {{-38, -10}, {-18, 10}})));
  ...
  Modelica.Blocks.Discrete.ZeroOrderHold zeroOrderHold(final startTime = startTime, final samplePeriod = 1 / (5 * f)) annotation(Placement(transformation(extent = {{-8, -10}, {12, 10}})));
equation
